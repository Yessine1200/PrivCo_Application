...
class TargetHeight extends StatefulWidget {

  @override
  _TargetHeightState createState() => _TargetHeightState();
}

class _TargetHeightState extends State<TargetHeight> {
    ...
    if (isValid) {
      ...
      try {
        await FirebaseFirestore.instance.collection('users').doc(id).update({
          'target weight': targetWeight.text.trim(),
        });
      } catch (e) {
        hasException = true;
      }
          ...
          child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Text('Target Weight',style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold),)
                ),
